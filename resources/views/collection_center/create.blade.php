    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2" style="filter: alpha(opacity=25); -moz-opacity: 0.3; opacity: 0.9; -khtml-opacity: 0.3;">
                <form method="POST" action="{{route('collectionCenter.store')}}">
                    {{ csrf_field() }}
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2>Crear medida centro de acopio</h2></div>
                        <div class="panel-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name = "nameCenter" class="form-control" placeholder="Centro de acopio 1..">

                                    @if ($errors->has('nameCenter'))
                                        <span class="help-block" style="color:red">
                                                <strong>{{ $errors->first('nameCenter') }}</strong>
                                            </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label> Meta(numero de bienes): </label>
                        ...
                        <div class="panel-footer">
                            <button class="btn btn-primary" type="submit">Crear centro de acopio</button>

        ...
        <div class="col-md-8 col-md-offset-2" style="filter: alpha(opacity=25); -moz-opacity: 0.3; opacity: 0.9; -khtml-opacity: 0.3;">
            <form method="POST" action="{{route('newCatastrophe.store')}}">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h2>Evento a beneficio</h2></div>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-10 col-md-offset-1 ">
                                ...
                                <textarea name="description" class="form-control" rows="5" cols="50" placeholder="Motivo del evento a beneficio ..."></textarea>

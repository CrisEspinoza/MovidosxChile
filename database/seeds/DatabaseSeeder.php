...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('r_n_vs')->insert([ 'name'=>'JulioXXX', 'last_name'=>'SerranoXXX','disponible'=>1,'mail'=>'julio.serrano@usach.cl']);
        DB::table('r_n_vs')->insert([ 'name'=>'JulioXXX', 'last_name'=>'SerranoXXX','disponible'=>1,'mail'=>'cristian.espinoza.s@usach.cl']);
